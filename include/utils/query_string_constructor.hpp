...
public:
    ...
    std::string GetMainQueryString(vector<std::string> &column_names, vector<LogicalType>& column_types, std::string& projected_columns_string, vector<std::string>& id_columns, idx_t reader_i, idx_t columns_to_remove, QueryType query_type);
