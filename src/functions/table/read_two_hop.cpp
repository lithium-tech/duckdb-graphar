...
// #include "functions/table/read_two_hop.hpp"
...
// // GetBindData
// //-------------------------------------------------------------------
// void ReadTwoHop::SetBindData(std::shared_ptr<graphar::GraphInfo> graph_info, std::shared_ptr<graphar::EdgeInfo> edge_info,
//                           unique_ptr<ReadTwoHopBindData>& bind_data) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::SetBindData")
...
//     if (base_ptr) {
//         auto* derived = dynamic_cast<ReadTwoHopBindData*>(base_ptr.get());
//         if (derived) {
//             base_ptr.release();
...
// // Bind
// //-------------------------------------------------------------------
// unique_ptr<FunctionData> ReadTwoHop::Bind(ClientContext& context, TableFunctionBindInput& input,
//                                          vector<LogicalType>& return_types, vector<string>& names) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::Bind Parse parameters");
...
//     auto bind_data = make_uniq<ReadTwoHopBindData>();
...
// // GetBaseReader
// //-------------------------------------------------------------------
// BaseReaderPtr ReadTwoHop::GetBaseReader(ClientContext& context, ReadTwoHopGlobalTableFunctionState& gstate) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::GetBaseReader");
...
// // SetFilter
// //-------------------------------------------------------------------
// void ReadTwoHop::SetFilter(ClientContext& context, ReadBaseGlobalTableFunctionState& gstate, idx_t ind,
//                                 const std::pair<int64_t, int64_t>& vid_range, const std::string& filter_column) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::SetFilter");
//     throw NotImplementedException("SetFilter not implemented for ReadTwoHop");
// }
// //-------------------------------------------------------------------
// // GetReader
// //-------------------------------------------------------------------
// ReaderPtr ReadTwoHop::GetReader(ClientContext& context, ReadBaseGlobalTableFunctionState& gstate,
//                              ReadBaseLocalTableFunctionState& lstate, idx_t ind, const std::string& filter_column) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::GetReader");
...
// // GetStatistics
// //-------------------------------------------------------------------
// // unique_ptr<BaseStatistics> ReadTwoHop::GetStatistics(ClientContext& context, const FunctionData* bind_data,
// //                                                   column_t column_index) {
// //     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::GetStatistics");
...
// //-------------------------------------------------------------------
// void ReadTwoHop::PushdownComplexFilter(ClientContext& context, LogicalGet& get, FunctionData* bind_data,
//                                             vector<unique_ptr<Expression>>& filters) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::PushdownComplexFilter");
//     if (!bind_data) {
//         throw InternalException("Bind data is nullptr");
//     }
//     auto read_bind_data = dynamic_cast<ReadTwoHopBindData*>(bind_data);
//     std::string filt;
...
// // GetFunction
// //-------------------------------------------------------------------
// TableFunction ReadTwoHop::GetFunction() {
//     TableFunction read_hop("read_two_hop", {LogicalType::VARCHAR}, Execute, Bind);
...
// // GetScanFunction
// //-------------------------------------------------------------------
// TableFunction ReadTwoHop::GetScanFunction() {
...
// // Init
// //-------------------------------------------------------------------
// unique_ptr<GlobalTableFunctionState> ReadTwoHop::Init(ClientContext& context, TableFunctionInitInput& input) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::Init");

//     auto bind_data = input.bind_data->Cast<ReadTwoHopBindData>();

//     auto gstate_ptr = make_uniq<ReadTwoHopGlobalTableFunctionState>();
...
//     }
//     // DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::check dst " + _temp);
...
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::function_name " + bind_data.function_name);
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::id_columns_num " + std::to_string(bind_data.id_columns_num));
//     _temp = "";
//     for (idx_t j = 0; j < gstate.column_ids.size(); j++) {
//         _temp += std::to_string(gstate.column_ids[j]) + " ";
//     }
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::column_ids(" + std::to_string(gstate.column_ids.size()) + ") " + _temp);
//     // _temp = "";
//     // for (idx_t j = 0; j < bind_data.flatten_prop_names.size(); j++) {
//     //     _temp += bind_data.flatten_prop_names[j] + " ";
//     // }
//     // DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::flatten_prop_names(" + std::to_string(bind_data.flatten_prop_names.size()) + ") " + _temp);
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::filter_column " + bind_data.filter_column);
//     _temp = "";
//     for (idx_t j = 0; j < bind_data.params.size(); j++) {
//         _temp += bind_data.params[j] + " ";
//     }
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::params(" + std::to_string(bind_data.params.size()) + ") " + _temp);
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::query_filter " + bind_data.query_filter);
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::graph_info_path " + bind_data.graph_info_path);
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHop::GlobalState::dstColumn " + std::to_string(gstate.dstColumn));
...
//     DUCKDB_GRAPHAR_LOG_DEBUG("ReadTwoHopHop::Init global_projected_inds");
...
// // InitLocal
// //-------------------------------------------------------------------
// unique_ptr<LocalTableFunctionState> ReadTwoHop::InitLocal(ExecutionContext& context, TableFunctionInitInput& input,
...
//     auto lstate_ptr = make_uniq<ReadTwoHopLocalTableFunctionState>();
//     auto& lstate = *lstate_ptr;
//     auto& gstate = gstate_ptr->Cast<ReadTwoHopGlobalTableFunctionState>();
...
// // Execute
// //-------------------------------------------------------------------
// void ReadTwoHop::Execute(ClientContext& context, TableFunctionInput& input, DataChunk& output) {
//     DUCKDB_GRAPHAR_LOG_TRACE("ReadTwoHop::Execute");
//     bool time_logging = GraphArSettings::is_time_logging(context);

//     ReadTwoHopGlobalTableFunctionState& gstate = input.global_state->Cast<ReadTwoHopGlobalTableFunctionState>();
//     ReadTwoHopLocalTableFunctionState& lstate = input.local_state->Cast<ReadTwoHopLocalTableFunctionState>();
