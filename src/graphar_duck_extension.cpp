...
static void LoadInternal(DatabaseInstance& instance) {
    ...
    auto graphar_duck_scalar_function =
        ScalarFunction("graphar_duck", {LogicalType::VARCHAR}, LogicalType::VARCHAR, GraphArDuckScalarFun);
...
void GrapharDuckExtension::Load(DuckDB& db) { LoadInternal(*db.instance); }
std::string GrapharDuckExtension::Name() { return "graphar_duck"; }
...
DUCKDB_EXTENSION_API const char* graphar_duck_version() { return duckdb::DuckDB::LibraryVersion(); }
}
