...
CustomAdjListChunkInfoReader::CustomAdjListChunkInfoReader(
...
Result<std::shared_ptr<CustomAdjListChunkInfoReader>> CustomAdjListChunkInfoReader::Make(
  ...
  return std::make_shared<CustomAdjListChunkInfoReader>(edge_info, adj_list_type,
                                                  prefix);
}
...
Result<std::shared_ptr<CustomAdjListPropertyChunkInfoReader>>
CustomAdjListPropertyChunkInfoReader::Make(
    const std::shared_ptr<EdgeInfo>& edge_info,
    const std::shared_ptr<PropertyGroup>& property_group,
    AdjListType adj_list_type, const std::string& prefix) {
  if (!edge_info->HasAdjacentListType(adj_list_type)) {
  ...
  return std::make_shared<CustomAdjListPropertyChunkInfoReader>(
